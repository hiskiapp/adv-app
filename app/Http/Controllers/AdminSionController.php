<?php namespace App\Http\Controllers;
	...
	class AdminSionController extends \crocodicstudio\crudbooster\controllers\CBController {
	    ...
	    public function cbInit() {
			...
			$this->col = [];
			$this->col[] = ["label"=>"Nomor","name"=>"number"];
			$this->col[] = ["label"=>"Judul","name"=>"title"];
			# END COLUMNS DO NOT REMOVE THIS LINE

			# START FORM DO NOT REMOVE THIS LINE
			$this->form = [];
			$this->form[] = ['label'=>'Nomor','name'=>'number','type'=>'number','validation'=>'required|integer|min:0','width'=>'col-sm-10'];
			...
			$this->form[] = ['label'=>'Lirik','name'=>'lyric','type'=>'wysiwyg','validation'=>'required|string|min:5|max:5000','width'=>'col-sm-10'];
			...
			//$this->form[] = ["label"=>"Lyric","name"=>"lyric","type"=>"textarea","required"=>TRUE,"validation"=>"required|string|min:5|max:5000"];
			# OLD END FORM
